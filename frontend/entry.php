...
<body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
        ...
        <section style="margin-left: 5%; width: 100%;">
            <div id="main" class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5" style="width: 100%;" >
                ...
                <div style="text-align: center; margin-top: 1.25rem;">
                    <h2 class="text-xl font-semibold mb-2">Delete User</h2>
                    <form id="userForm" style="display: inline-block; width: 100%; max-width: 400px;">
                        <div class="mb-4">
                            ...
                            <select id="user" name="user" class="px-3 py-2 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full">
                                <?php foreach ($users as $user) { ?>
                                    <option value="<?php echo $user['username'] . ',' . $user['type']; ?>">
                                        <?php echo $user['username'] . ' (' . $user['type'] . ')'; ?>
                                    </option>
                                <?php } ?>
                            </select>
                        </div>
    ...
    <script>
        function deleteUser() {
            ...
            var selectedUser = userSelect.value.split(',');

            var formData = new FormData();
            formData.append('username', selectedUser[0]);
            formData.append('type', selectedUser[1]);
            ...
            .then(data => {
                ...
                // Remove deleted user from the dropdown
