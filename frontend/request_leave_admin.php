            ...
            $(document).on('click', '.updateButton', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Optionally, you can update frontend elements if needed
                        // Example: $('#attendanceTable').html(response);

                        // Reset select element if needed
                        // updateButton.closest('form').find('select[name="leave_status"]').val('pending');
                    },
...
<body class="bg-gray-100">
    ...
    <main class="container mx-auto px-4 py-8" style="margin-top: 50px;">
        ...
        <form method="POST" action="" class="mb-4">
            ...
            <button type="submit"
                class="mt-4 px-4 py-2 bg-blue-500 text-white rounded shadow">Submit</button>
        </form>
